...
import com.fromzerotohero.roomapplication.databinding.ItemRowsBinding
...
class ItemAdapter(
    ...
    class ViewHolder(binding: ItemRowsBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemRowsBinding.inflate(
